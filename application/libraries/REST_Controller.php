...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        if ($this->input->is_ajax_request() === FALSE && $this->config->item('rest_ajax_only'))
        {
            ...
            $this->response([
                    $this->config->item('rest_status_field_name') => 'ajax_only',
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        {
            $this->response([
                    $this->config->item('rest_status_field_name') => 'unsupported',
        ...
        if ($this->config->item('rest_enable_keys') && $use_key && $this->_allow === FALSE)
        {
            ...
            $this->response([
                    $this->config->item('rest_status_field_name') => 'invalid_api_token',
        ...
        if ($this->config->item('rest_enable_keys') && $use_key && empty($this->rest->key) === FALSE && $this->_check_access() === FALSE)
        {
            ...
            $this->response([
                    $this->config->item('rest_status_field_name') => 'api_key_unauthorized',
        ...
        {
            $this->response([
                    $this->config->item('rest_status_field_name') => 'unknown_method',
        ...
        if ($this->config->item('rest_enable_keys') && empty($this->rest->key) === FALSE)
        {
            ...
            {
                $response = [
                  $this->config->item('rest_status_field_name') => 'api_key_time_limit',
            ...
            if($authorized === FALSE)
            {
                ...
                $response = [
                  $this->config->item('rest_status_field_name') => 'api_key_permissions',
        ...
        {
            $response = [
              $this->config->item('rest_status_field_name') => 'ip_address_time_limit',
    ...
    protected function _check_php_session()
    {
        ...
        if ( ! $this->session->userdata($key))
        {
            // Display an error response
            $this->response([
                    $this->config->item('rest_status_field_name') => 'unauthorized',
    ...
    protected function _prepare_digest_auth()
    {
        ...
        if (strcasecmp($digest['response'], $valid_response) !== 0)
        {
            // Display an error response
            $this->response([
                    $this->config->item('rest_status_field_name') => 'invalid_credentials',
    ...
    protected function _check_blacklist_auth()
    {
        ...
        if (preg_match($pattern, $this->config->item('rest_ip_blacklist')))
        {
            // Display an error response
            $this->response([
                    $this->config->item('rest_status_field_name') => 'ip_denied',
    ...
    protected function _check_whitelist_auth()
    {
        ...
        {
            $this->response([
                    $this->config->item('rest_status_field_name') => 'ip_unauthorized',
