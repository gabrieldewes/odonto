<?php
  ...
  define("TIMEBEFORE_MINUTES",     '{num} minutos atrás' );
  define("TIMEBEFORE_HOUR",        '{num} hora atrás' );
  define("TIMEBEFORE_HOURS",       '{num} horas atrás' );
  define("TIMEBEFORE_DAYS",        '{num} dias atrás' );
  define("TIMEBEFORE_WEEK",        '{num} semana atrás' );
  define("TIMEBEFORE_WEEKS",       '{num} semanas atrás' );
  define("TIMEBEFORE_MONTH",       '{num} mês atrás' );
  define("TIMEBEFORE_MONTHS",      '{num} meses atrás' );
