...
INSERT INTO odonto.user (first_name, last_name, username, email, password, active, created_by, created_at, last_modified_by, last_modified_at, deleted) VALUES
  ('User', 'User', 'user', 'user@admin.com', '$2y$10$ocDVxugauG.bkdMTx2hVcOXINbE7hio/3RblV3B8QlQiNE5K8N2h2',   '1', 'system', now(), 'system', now(), '0'),
  ...
  ('Contributor', 'Butor', 'contributor', 'contributor@admin.com', '$2y$10$dv5F4h5XbVar/6qUa7PqUeKnVWgCfdtoiIV5R9SaZClVrC8wBabuO', '1', 'system', now(), 'system', now(), '0');
